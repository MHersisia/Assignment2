...
public class ShowFrame extends JFrame {
	...
	public ShowFrame(Pattern p) {
		...
		lab = new JLabel("Name :       "+pattern.getName());
		c.gridx = 0;
		c.gridy = 0;
		c.anchor = GridBagConstraints.WEST;
		panel.add(lab,c);
		lab4 = new JLabel("<html><body style='width: 300 px'>"+"Context:    "+pattern.getContext());
		c.gridx = 0;
		c.gridy = 1;
		panel.add(lab4,c);
		...
		lab6 = new JLabel("<html><body style='width: 300 px'>"+"Solution:                       "+pattern.getSolution());
		c.gridx = 0;
		c.gridy = 3;
		panel.add(lab6,c);
		
		lab7 = new JLabel("Consequences:           "+pattern.getConsequences());
		c.gridx = 0;
		c.gridy = 4;
		panel.add(lab7,c);
